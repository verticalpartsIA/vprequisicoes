    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (data) {
          ...
          // Lógica robusta para itens: se não houver itens explícitos (M2-M6), criamos um item virtual
          let rawItems = data.metadata?.itens || data.details?.itens || [];
          
          if (rawItems.length === 0) {
            // Criar item virtual baseado no módulo
            ...
            rawItems = [{
              nome: moduleLabels[data.module] || 'Solicitação Geral',
              quantidade: 1,
