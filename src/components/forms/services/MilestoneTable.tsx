    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
           ...
           <div>
              <p className="text-sm font-bold text-slate-900 uppercase tracking-tighter italic">Cronograma de Medição</p>
              <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">A soma deve ser exatamente 100%</p>
           </div>
        </div>

        <div className={`px-4 py-2 rounded-full border flex items-center gap-2 transition-all duration-300 ${isComplete ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-500' : 'bg-slate-50 border-slate-200 text-slate-400'}`}>
      ...
      <div className="overflow-hidden border border-surface-border rounded-2xl bg-white">
              ...
              <tr key={field.id} className="hover:bg-slate-50 transition-colors">
                <td className="p-3">
                  <input
                    ...
                    className="w-full bg-transparent border-none p-2 text-xs text-slate-900 placeholder:text-slate-400 outline-none focus:ring-1 focus:ring-brand/30 rounded-lg"
                  />
                ...
                <td className="p-3">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-surface-border p-2 text-xs text-center text-slate-900 rounded-xl outline-none focus:border-brand transition-all"
                  />
                </td>
                <td className="p-3">
                  <input
      ...
      <div className="p-4 bg-slate-50 rounded-2xl border border-surface-border flex items-start gap-4">
